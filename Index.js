const {
  ...
  const ownerNumber = ['923360679553']
  
  //===================SESSION-AUTH============================
  if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
  if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
  const sessdata = config.SESSION_ID.split("ZAINU~")[1];
  ...
  console.log('ZAINU-MD connected to whatsapp ✅')
  ...
  ║ https://whatsapp.com/channel/0029Vb5ooWm6LwHq7ivWSF0C              
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║ https://wa.me/message/U2XWLREBMYFZI1                 
  ╠═════════════════╣
  ║      your name               
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ Zainu Rajpoot      
  ╚═════════════════╝
`;
  conn.sendMessage(923360679553 + "@s.whatsapp.net", { image: { url: `https://ibb.co/LhPtBB6x` }, caption: up })
...
if(senderNumber.includes("923360679553")){
  if(isReact)return;
  m.react("🔓");  }
